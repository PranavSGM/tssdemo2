...
echo -- Ingesting : ~/workspace/tssdemo2/src/main/resources/csv/emp1.csv TO /tssdemo2/l1/csv .....

hdfs dfs -put ~/workspace/tssdemo2/src/main/resources/csv/emp1.csv /tssdemo2/l1/csv
